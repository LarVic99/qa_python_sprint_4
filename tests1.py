...
class TestBooksCollector:
    ...
    # Fixture для добавления книг в books_genre
    @pytest.fixture
    ...
    # Fixture для работы с избранным
    @pytest.fixture
    ...
    # Параметризированный тест для проверки длины имени книги и уникальности
    ...
    # Тест на установку жанра книги с несуществующей книгой
    ...
    # Тест на получение всего словаря жанров книг
    ...
    # Тест на пустой словарь жанров книг
    ...
    # Параметризированный тест на добавление книги в избранное
    @pytest.mark.parametrize("book, expected", [
        ("Книга в избранное", ["Книга в избранное"]),  # книга добавляется в избранное
        ("Неизвестная книга", []),  # книга не добавляется, так как она не в books_genre
    ])
    def test_add_book_in_favorites(self, book, expected):
        collector = BooksCollector()
        collector.add_new_book(book)  # добавляем книгу в books_genre
        collector.add_book_in_favorites(book)  # добавляем книгу в избранное
